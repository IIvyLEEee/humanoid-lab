...
.. code-block:: bash
    ...
    # Usage
    python l7_csv_to_npz.py --input_file LAFAN/dance1_subject2.csv --input_fps 30 --frame_range 122 722 \
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    robot_joint_indexes, dof_name_debug = robot.find_joints(joint_names, preserve_order=True)
    print("dof_name_debug:", dof_name_debug)
    # exit(-1)
    ...
    while simulation_app.is_running():
        ...
        # print('robot_joint_indexes:',robot_joint_indexes)
        # print('dof_name_debug:',dof_name_debug)
        ...
        # print('log["body_pos_w"]:\n',log["body_pos_w"])
        # print('log["body_pos_w"].shape:\n',log["body_pos_w"].shape)
        # print('log["body_pos_w"][0].shape:\n', log["body_pos_w"][0].shape)
            ...
            if use_wandb:
                ...
                try:
                    ...
                    run.link_artifact(
                        ...
                        aliases=["latest"],  # 或者其他你想要的别名，比如 ["v1", "best"]
                    )
